...
Smart QR은 웹사이트 주소(URL)를 입력하면 즉시 QR 코드를 생성하고, 클릭 한 번으로 고품질 JPG 이미지로 다운로드할 수 있는 웹 애플리케이션입니다.
...
2. index.html과 같은 폴더에 사용할 logo.png 이미지 파일을 준비합니다.
